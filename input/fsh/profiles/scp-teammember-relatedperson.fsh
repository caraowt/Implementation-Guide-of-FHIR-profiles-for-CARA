Profile: ScpTeamMemberRelatedPerson
Parent: RelatedPerson
Id: scp-teammember-relatedperson
Title: "SCP - Team Member - Related Person"
Description: "The Team Member of a Shared Care Plan with the profile Caregiver."
...
* identifier contains accountSlice 1..1 and scpSlice 1..1 and memberSlice 1..1
* identifier[accountSlice].system = "urn:cara:account"
* identifier[scpSlice].system = "urn:cara:scp"
* identifier[memberSlice].system = "urn:cara:scp:member"
